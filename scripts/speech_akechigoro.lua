...
return {
	ACTIONFAIL =
	{
        ...
        GIVE =
        {
            ...
            DEAD = "Oop! too bad, my dear dead pal.",
            SLEEPING = "Too unconscious to care.",
            BUSY = "Nah I don't have time for that.",
        ...
        ATTUNE =
        {
            NOHEALTH = "I really need to see a doctor right now.",
        },
        MOUNT =
        {
        ...
        SLAUGHTER =
        {
            TOOFAR = "You won't be lucky next time.",
        },
        REPLATE =
        {
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Nice texture!",
		PAINFUL = "I don't feel so good.",
		SPOILED = "It was g.o.o.d! (fake prince smile)",
		STALE = "I think that was starting to turn.",
		INVALID = "I can't eat that!",
        YUCKY = "It would be too disgusting to put in my mouth!",
	...
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "that frightening lightning almost kills me!",
    ...
    --lavaarena event
    ANNOUNCE_REVIVING_CORPSE = "You own me once.",
    ANNOUNCE_REVIVED_OTHER_CORPSE = "Good new life!",
	...
	BATTLECRY =
	{
		...
		SPIDER = "My gun is ready! Come on Spiderrr",
	...
	COMBAT_QUIT =
	{
		...
		PREY = "You won't survive next time!",
